...
// =============================================================================
// DIAGNOSZTIKA: KÖRNYEZETI VÁLTOZÓK ELLENŐRZÉSE INDULÁSKOR
// =============================================================================
console.log('--- INDULÁSI KÖRNYEZETI VÁLTOZÓK ELLENŐRZÉSE ---');
console.log(`NODE_ENV: ${process.env.NODE_ENV}`);
console.log(`FRONTEND_URL: ${process.env.FRONTEND_URL}`);
console.log(`MAIL_SENDER_NAME: ${process.env.MAIL_SENDER_NAME}`);
